...
sys.path.append('/Users/danmossing/Documents/python/keras/')
from test_keras import fit_GLM
...
#	self.channels = spikes.shape[0]
	...
	for i in range(0,self.channels): # (10,self.channels,7):
		...
		st = np.hstack((stimexp,otherspikes.T))
		Ntrain = 21000
		model, score = fit_GLM(st,spike,Ntrain)
